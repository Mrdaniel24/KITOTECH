    ...
    <section className="hero">
      ...
      <div className="hero-inner">
        ...
        <div className="hero-copy">
          <div className="hero-eyebrow" key={'e'+slide}>{cur.eyebrow}</div>
        ...
        <div className="hero-visual">
          {slides.map((s, i) => (
            <div key={i} className={`hero-img ${i === slide ? 'active' : ''}`}
          ...
          <div className="hero-fallback">
            ...
            <img src="../../assets/logo-mark-white.png" alt="" className="hero-fallback-logo"/>
          </div>
        </div>
      ...
      <div className="hero-float-stats" ref={panelRef}>
        <div className="hfs-item">
          <div className="hfs-num">
            <span className="hfs-val">{v1.toLocaleString()}</span><span className="hfs-unit">+</span>
          </div>
        ...
        <div className="hfs-item">
          <div className="hfs-num">
            <span className="hfs-val">{v2.toFixed(2)}</span><span className="hfs-unit">%</span>
          </div>
        ...
        <div className="hfs-item">
          <div className="hfs-num">
            <span className="hfs-prefix">&lt;</span><span className="hfs-val">{v3}</span><span className="hfs-unit">ms</span>
          </div>
